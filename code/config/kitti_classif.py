...
resize_train                 = None #(224, 224) # Resize the image during training (Height, Width) or None
resize_valid                 = None #(224, 224)   # Resize the image during validation
resize_test                  = None #(224, 224)     # Resize the image during testing
