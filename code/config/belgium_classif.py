...
weights_dir                  = 'weights'
weights_file                 = 'weightstt100k.hdf5'  # Training weight file name
...
resize_train                 = (224,224) #(224, 224) # Resize the image during training (Height, Width) or None
resize_valid                 = (224,224) #(224, 224)   # Resize the image during validation
resize_test                  = (224,224) #(224, 224)     # Resize the image during testing
...
norm_imageNet_preprocess           = False     #False Normalize following imagenet procedure
