"""
This is simply a keras 2.0 API update for FCN8
"""
# Custom layers import
from code_base.layers.ourlayers import CropLayer2D, NdSoftmax
#from code_base.layers.deconv import Conv2DTranspose
...
def build_fcn8(img_shape=(3, None, None), nclasses=8, l2_reg=0.,
    ...
    # DECONTRACTING PATH
    # Unpool 1
    score_pool4 = Conv2D(nclasses, (1, 1), kernel_initializer=init, activation = 'relu', padding='same',
                                name='score_pool4',
                                kernel_regularizer=l2(l2_reg))(pool4)
    score2 = Conv2DTranspose(nclasses, (4, 4), score_fr._keras_shape, kernel_initializer=init,
                             activation='linear', padding='valid', subsample=(2, 2),
    ...
    score4 = Conv2DTranspose(nclasses, (4, 4), score_fused._keras_shape, kernel_initializer=init,
                             activation='linear', padding='valid', subsample=(2, 2),
    ...
    upsample = Conv2DTranspose(nclasses, (16, 16), score_final._keras_shape, kernel_initializer=init,
                               activation='linear', padding='valid', subsample=(8, 8),
