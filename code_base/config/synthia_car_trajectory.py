...
cnnLstmToFc_conv_paras        = [cnnDict(11,10,3,1,1), cnnDict(10,5,3,1,1),cnnDict(5,2,3,1,1)]              # a list composed of dicts representing parameters of each conv, {'in_channels': ,
                                                                                      # 'out_channels': ,
                                                                                      # 'kernel_size': ,
                                                                                      # 'stride': ,
                                                                                      # 'padding': }
