...
resize_train                 = (270, 310)      # Resize the image during training (Height, Width) or None
resize_valid                 = (270, 310)      # Resize the image during validation
resize_test                  = (270, 310)      # Resize the image during testing
