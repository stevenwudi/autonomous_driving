...
sequence_name = 'SYNTHIA_RAND_CVPR16'  # [SYNTHIA_RAND_CVPR16, SYNTHIA-SEQS-01, SYNTHIA-SEQS-06]
local_path = '/home/stevenwudi/PycharmProjects/autonomous_driving'
dataset_path = '/media/samsumg_1tb/synthia/Datasets'
...
classes = {'void': 0, 'sky': 1, 'building': 2, 'road': 3, 'sidewalk': 4, 'fence': 5, 'vegetation': 6, 'pole': 7,
           'car': 8, 'sign': 9, 'pedestrian': 10, 'cyclist': 11}

class_cityscape = {'road': 0, 'sidewalk': 1, 'building': 2, 'fence': 4, 'pole': 5, 'sign': 7, 'vegetation': 8, 'sky': 10,
                   'pedestrian': 11, 'cyclist': 12, 'car': 13}
...
video_sequence_train = False  # This is the flag for Synthia CVPR 16 paper (False)
train_ratio = 0.8
valid_ratio = 0.1
